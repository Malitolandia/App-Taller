...
|---|---|---|
| **Recurrente** | Mensual o semanal | Representa una obligación que vuelve a generarse. Cuando se paga el período actual, el sistema avanza al siguiente período y conserva la obligación activa. |
...
```text
faltante_recurrente = suma de saldos pendientes de obligaciones Recurrentes activas
...
Los saldos menores o iguales a $0,009 se consideran cero para evitar residuos de redondeo. Por ello, una Variable completamente pagada no aumenta **Falta por pagar**.
...
| Recurrente mensual | Conserva frecuencia, fecha y subtotal recurrente. |
